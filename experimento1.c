...
int main() {
    ...
    while (i < 1000000) {
        ...
        printf("Cartas 2: %d %d %d %d\n", jugador2.cartas[0],
               jugador2.cartas[1], jugador2.cartas[2], jugador2.cartas[3]);
        printf("Cartas 4: %d %d %d %d\n", jugador4.cartas[0],
               jugador4.cartas[1], jugador4.cartas[2], jugador4.cartas[3]);
        printf("####################################################\n");
        /*
        ...
        */
        ...
        ordenarManos(manos);
        int ganaGrande = ganadorGrande(manos);
        if ((ganaGrande == 0) || (ganaGrande == 2)) {
            mano++;
        } else
            postre++;
        double porcentaje =
            postre > 0 ? ((double)mano / (mano + postre)) * 100 : 0;
